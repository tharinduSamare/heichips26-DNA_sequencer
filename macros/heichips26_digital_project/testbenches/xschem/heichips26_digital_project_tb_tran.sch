...
N 960 -480 1000 -480 {lab=reset_n}
N 960 -460 1000 -460 {lab=enable}
...
C {devices/lab_wire.sym} 960 -480 0 0 {name=p12 sig_type=std_logic lab=reset_n}
C {devices/gnd.sym} 1100 -320 0 0 {name=l7 lab=GND}
C {devices/vdd.sym} 1100 -560 0 0 {name=l10 lab=VDD}
C {devices/lab_wire.sym} 960 -460 0 0 {name=p13 sig_type=std_logic lab=enable}
